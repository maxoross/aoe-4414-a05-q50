...
# Finds the intersection point between a ray and the Earth reference ellipsoid
#
# Parameters:
# d_l_x: x-component of ray direction
# d_l_y: y-component of ray direction
# d_l_z: z-component of ray direction
